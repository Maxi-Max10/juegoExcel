...
(2, 'Básico', 'SUMA', 'Total de ventas', 'Calcula el total del rango B2:B6 en la celda E3.', '=SUMA(B2:B6)', NULL, 'E3', 10),
...
(7, 'Básico', 'SUMA', 'Bloque corto', 'Suma el rango C2:C4 en la celda E3.', '=SUMA(C2:C4)', NULL, 'E3', 11),
...
(12, 'Básico', 'Operaciones básicas', 'Balance rápido', 'Suma B2 y C2, luego resta D2, todo en E3.', '=B2+C2-D2', NULL, 'E3', 12),
...
(15, 'Básico', 'Operaciones básicas', 'Costo combinado', 'Multiplica B5 por C5 y luego suma D5 en E6.', '=B5*C5+D5', NULL, 'E6', 12),
(16, 'Básico', 'Operaciones básicas', 'Promedio simple simulado', 'Suma B6 y C6, luego divide entre D6 en E2.', '=(B6+C6)/D6', NULL, 'E2', 13),
...
(19, 'Básico', 'Operaciones básicas', 'Multiplicación acumulada', 'Suma B2*C2 y B3*C3 en E5.', '=B2*C2+B3*C3', NULL, 'E5', 13),
